...
impl Default for Debug {
    fn default() -> Self {
        Self {
            ...
            rms: Arc::new(AtomicF32::new(0.)),
        }
    }
}

impl Debug {
    pub fn update(&mut self, sample_value: f32, sample_rate: f32, mix_level: f32, gain_level: f32, rms: f32) {
